  ...
  const handleGenerateSuggestions = () => {
    ...
    setTimeout(() => {
      ...
      const generatedSuggestions = [
        "What are the best practices for improving AI visibility?",
        "How does schema markup affect AI understanding of my content?",
        "Top strategies for optimizing content for voice assistants",
        "How to get my website cited by ChatGPT and other AI tools",
        "What is the difference between traditional SEO and AI visibility?",
        "Step-by-step guide to implementing schema.org markup",
        "How can entity coverage analysis improve my website's AI visibility?"
      ];
